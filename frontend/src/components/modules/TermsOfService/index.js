...
const TermsOfService = props => {
  return (
    <Container text className="TermsOfService" style={{ marginTop: '25px' }}>
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Photomy's
        Website.
      </p>
      <br />
      ...
      <p>
        ...
        continue to use Photomy's website if you do not accept all of the terms and conditions
        stated on this page.
      </p>
      <p>
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Photomy's website you consent to the use of cookies
        in accordance with Photomy’s privacy policy.
      </p>
      <p>
      ...
      <p>
        ...
        and/or print pages from <Link to="www.photomy.si"> www.photomy.si</Link> for your own
      ...
      <p>
        ...
        with the hyperlink outweighs the absence of Photomy; and (d) where the link is in the
        context of general resource information or is otherwise consistent with editorial content in
      ...
      <p>
        ...
        <a href="mailto:support@photomy.si" title="send an email to support@photomy.si">
          support@photomy.si
        </a>. Please include your name, your organization name, contact information (such as a phone
      ...
      <p>
        No use of Photomy’s logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      <h2>Iframes</h2>
      <p>
