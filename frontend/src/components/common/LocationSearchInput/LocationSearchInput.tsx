...
type Props = {
  ...
  handleError: (status: string, clearSuggestion: () => void) => void;
...
const LocationSearchInput: React.StatelessComponent<Props> = ({
  address,
  errorMessage,
  handleChange,
  handleSelect,
                ...
                <div className="Demo__autocomplete-container">
                  {suggestions.map((suggestion: any) => {
                    ...
                    return (
                      ...
                      <div key={suggestion} {...getSuggestionItemProps(suggestion, { className })}>
